// Pokemon utils from Skyra (https://github.com/skyra-project/skyra) Copyright 2021 Antonio Román, used under the Apache-2.0 License
import type {
	Query,
...
export const POKEMON_GRAPHQL_API_URL = 'https://graphqlpokemon.favware.tech';
...
export const resolveColor = (col: string) => {
	switch (col) {
		case 'Black':
			return 0x323232;
		case 'Blue':
